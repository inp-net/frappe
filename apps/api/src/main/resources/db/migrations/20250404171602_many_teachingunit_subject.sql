...
ALTER TABLE subjects_teaching_units ADD CONSTRAINT "FK560p4sn5f9qxmgs7m2oxae06q" FOREIGN KEY (subject_id) REFERENCES teaching_units (id);

-- changeset many_teachingunit_subject:20250404171602-4
ALTER TABLE subjects_teaching_units ADD CONSTRAINT "FKfv3qxpaff6hxv5weogmysmr3g" FOREIGN KEY (teaching_unit_id) REFERENCES subjects (id);
